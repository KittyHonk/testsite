...
import {checkHarrowing, createHarrowing, getAllHarrowing} from "../../http/TableApi";
...
const TableBody = React.forwardRef((props, ref) => {
    ...
    useEffect(() => {
        checkHarrowing(row_owner, date.current).then(data => {
            getAllHarrowing(row_owner, date.current).then(data => {
                setValue(data)
            })
        })
    }, [date.current])
    ...
    useImperativeHandle(ref, () => ({
        newRow (date) {
            createHarrowing(
                ...
                getAllHarrowing(row_owner, date).then(data => {
                    setValue(data)
                })
            })
        },
